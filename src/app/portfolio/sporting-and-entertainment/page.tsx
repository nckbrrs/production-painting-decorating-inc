...
export default function SportingAndEntertainmentPortfolio() {
	...
	return (
		<div className={pageContainerStyling}>
			...
			<div className={portfolioContainerStyling}>
				<h1 className={headerTextStyling}>
					Our Portfolio | Sporting & Entertainment
				</h1>
				...
				<span className="space-y-6">
					{portfolioEntries
						.filter(
							(pe) => pe.category === "Sporting & Entertainment"
						)
						.map((pe, idx) => (
							<Card key={idx}>
